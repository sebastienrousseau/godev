...
<p align="center">
  <img src="assets/logo.svg" alt="godev logo" width="140" />
</p>

<h1 align="center">godev</h1>

<p align="center">
  Portable, hardened Go 1.24+ development container with TMUX IDE,
  Model Context Protocol (MCP) AI agent tooling, gopls, golangci-lint, delve, mobile WebTTY, and dotfiles bootstrap.
</p>

<p align="center">
  <a href="https://github.com/sebastienrousseau/godev/actions/workflows/ci.yml"><img src="https://img.shields.io/github/actions/workflow/status/sebastienrousseau/godev/ci.yml?style=for-the-badge&logo=github" alt="Build" /></a>
...
Clone this repository and spin up a complete, hardened Go terminal IDE in seconds:
...
`godev` is the Go member of the [`langdev`](https://github.com/sebastienrousseau/langdev) suite:
...
- **Center-Top (56% W, 70% H)**: Editor pane loaded with Neovim and `gopls`.
- **Center-Bottom (56% W, 30% H)**: Integrated bash terminal with Go toolchain on PATH.
